const regiones = {
    ...
    "Región de Magallanes y la Antártica Chilena": ["Antártica", "Laguna Blanca", "Porvenir", "Primavera", "Punta Arenas", "Puerto Natales", "Río Verde", "San Gregorio", "Timaukel", "Torres del Paine"],
...
const updateComunas = () => {
    ...
    if (regiones[selectedRegion]) {
      regiones[selectedRegion].forEach(region => {
        let option = document.createElement("option");
        option.value = region;
        option.text = region;
